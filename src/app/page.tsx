      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-4xl px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            <StatCounter value={114} label="Competencies" />
            <StatCounter value={3} label="Difficulty Levels" />
            <StatCounter value={16} label="Topic Tags" />
            <StatCounter value={100} suffix="%" label="Evidence-Based" />
          </div>
        </div>
      </section>
          ...
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-gray-500 max-w-xl mx-auto">
                Hover over each founder to learn more about the team behind True
                Competency.
              </p>
            </div>
          </FadeIn>
